...
class NTPClient(object):
    # Leap indicator – a number that warns about a second of coordination
    LEAP_ATR = {
        0: "No warning",
...
if __name__ == '__main__':
    ...
    print("Round trip time: {:.0f} ms".format(ntp.rtt * 1000))
    print("Offset: {:.0f} ms".format(ntp.offset * 1000))
