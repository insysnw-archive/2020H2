        ...
        public void run() {
            while (true) {
                ...
                try {
                    ...
                    byte[] temp1 = ByteConverterUtilsClient.append(userNameLength, userName);
                    byte[] temp2 = ByteConverterUtilsClient.append(temp1, bUserWorldLength);
                    byte[] output = ByteConverterUtilsClient.append(temp2, bUserWord);
                    out.write(output);
                    out.flush();
                } catch (IOException e) {
                    e.printStackTrace();
