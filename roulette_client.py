...
while True:
    ...
    if cmd == 'exit':
        ...
        print('bets - get all bets. If output is empty - there`s no bets yet.')
        ...
        try:
            ...
            print('Whoaaaah so much money! We ain`t got so much in our bank! Please enter something smaller...')
        continue
